...
class InstagramBot:
    ...
    def __init__(self, username, password):
        ...
        self.driver = webdriver.Chrome('/home/anatolii/Desktop/InstagramBot/chromedriver')     # Change path for "chromedriver" file
...
username = "YourInstagramLogin"            # Change your Login for Instagram
password = "YourInstagramPassword"         # Change your Password for Instagram

ig = InstagramBot(username, password)
ig.login()

hashtags = ['amazing', 'beautiful', 'adventure', 'photography', 'nofilter',
            'newyork', 'marvel', 'avengers', 'artsy', 'alumni', 'lion', 'best', 'fun', 'happy',
